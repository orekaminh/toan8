...
(function () {
  ...
  MATH8.renderFormulas = function () {
    ...
    root.innerHTML = '<p style="color:#55617a">Tổng hợp <b>' + count + '</b> công thức/định lí chính của Toán 8, gom theo chương. Bấm tên bài để mở bài học đầy đủ.</p>' + html;
    MATH8.typeset(root);
  };
})();
