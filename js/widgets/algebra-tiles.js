...
(function () {
  ...
  MATH8.Widgets["algebra-tiles"] = function (mount, cfg) {
    ...
    renderPile(tiles);
    MATH8.typeset(mount.querySelector(".widget-hint")); // chú thích có thể chứa công thức
